  ...
  function functionName() {
    var x = "Omar Salama";
    input_name.value = x;
    // var x = document.getElementById("changename").value;
    // document.getElementById("input_name").innerHTML = change_name.value;

    // change_name.value = "Omar Salama";
    // document.getElementById("input_name").innerHTML = "Omar Salama";
  }
